...
import AuthFormTitle from "@/pages/identity/components/AuthFormTitle";
import LoginForm from "@/components/forms/LoginForm";
import {
  LoginFormDefaultValues,
  LoginFormSchema,
} from "@/schemas/login-form-schema";
import AuthAlternativesSeparator from "@/pages/identity/components/AuthAlternativesSeparator";
import SocialAuthenticationActions from "@/pages/identity/components/SocialAuthenticationActions";
            ...
            <div className="flex flex-wrap z-10 flex-col gap-5 lg:w-auto md:my-3 p-6">
              ...
              {!verifyUser && (
                <>
                  ...
                  <SocialAuthenticationActions isLoading={loading} />
                </>
              )}
            </div>
          </div>
